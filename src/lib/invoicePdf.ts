...
// ============================================================================
// Renders one Invoice as a real, downloadable tax-invoice-style PDF —
// company letterhead, Bill To block (this dealer's own name/phone/email/
// GSTIN), an item line with unit price and amount, and GST + grand total for
// anything that actually carries a price (order confirmation/dispatch/
// delivery/partial). Client-side only (jsPDF) — no server round-trip.
// Kept as a near-identical copy of apps/web/lib/invoicePdf.ts (staff CRM) —
// DMS is a separate deployment with no shared package to pull it from.
// ============================================================================
