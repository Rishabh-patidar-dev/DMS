...
function LoginForm() {
    ...
    const onSubmit = async (data)=>{
        setServerError(null);
        const { ok, data: result } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crm$2f$dealerAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["crmFetch"])('/api/v1/dealer-auth/login', {
            method: 'POST',
...
_s(LoginForm, "k9qwk4EgZHebm+YO3epKemJFpwQ=", false, function() {
    return [
...
//# sourceMappingURL=src_0istc05._.js.map