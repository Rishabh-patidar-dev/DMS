...
"[project]/src/app/(portal)/leads/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LeadsPage() {
    ...
    const load = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LeadsPage.useCallback[load]": async ()=>{
            setLoading(true);
            const params = new URLSearchParams();
            if (statusFilter) params.set('status', statusFilter);
            if (search) params.set('search', search);
            const qs = params.toString();
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crm$2f$dealerAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["crmFetch"])(`/api/v1/dealer-portal/leads${qs ? `?${qs}` : ''}`);
            setLeads(data.leads ?? []);
            setLoading(false);
        }
    }["LeadsPage.useCallback[load]"], [
        statusFilter,
        search
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LeadsPage.useEffect": ()=>{
            ...
            return ({
                "LeadsPage.useEffect": ()=>clearTimeout(t)
            })["LeadsPage.useEffect"];
        }
    }["LeadsPage.useEffect"], [
        load,
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LeadsPage.useMemo[stats]": ()=>{
            const needsFollowUp = leads.filter({
                "LeadsPage.useMemo[stats]": (l)=>[
                        'ASSIGNED',
                        'ACCEPTED',
                        'CONTACTED'
                    ].includes(l.assignment.status)
            }["LeadsPage.useMemo[stats]"]).length;
            const converted = leads.filter({
                "LeadsPage.useMemo[stats]": (l)=>l.assignment.status === 'CONVERTED'
            }["LeadsPage.useMemo[stats]"]).length;
            const avgScore = leads.length ? Math.round(leads.reduce({
                "LeadsPage.useMemo[stats]": (s, l)=>s + (l.score ?? 0)
            }["LeadsPage.useMemo[stats]"], 0) / leads.length) : 0;
            return {
                total: leads.length,
                needsFollowUp,
                converted,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$portal$2f$StatTile$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatTile"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            ASSIGNMENT_STATUSES.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: s,
                                    children: s
                                }, s, false, {
                                    fileName: "[project]/src/app/(portal)/leads/page.tsx",
            ...
            showForm && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NewLeadForm, {
                onDone: ()=>{
                    setShowForm(false);
                    load();
                }
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                lineNumber: 106,
                                columnNumber: 15
                            }, this) : leads.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    colSpan: 5,
                                    className: "px-4 py-10 text-center text-ink/40",
                                ...
                                lineNumber: 108,
                                columnNumber: 15
                            }, this) : leads.map((l)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(LeadsPage, "7JwBlyREkVYenzL2oPCBskGE7Bc=", false, function() {
    return [
...
function NewLeadForm({ onDone }) {
    ...
    const submit = async ()=>{
        setSaving(true);
        setError(null);
        const { ok, data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crm$2f$dealerAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["crmFetch"])('/api/v1/dealer-portal/leads', {
            method: 'POST',
            body: JSON.stringify({
                firstName,
...
_s1(NewLeadForm, "jiK5VAEFqTaV2KU8vJABlP7RmcI=");
_c1 = NewLeadForm;
var _c, _c1;
__turbopack_context__.k.register(_c, "LeadsPage");
__turbopack_context__.k.register(_c1, "NewLeadForm");
...
//# sourceMappingURL=_18dohbx._.js.map