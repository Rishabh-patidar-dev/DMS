module.exports = [
"[project]/src/components/portal/PortalShell.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PortalShell({ children }) {
    ...
    async function handleSignOut() {
        setSigningOut(true);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$crm$2f$dealerAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["crmFetch"])('/api/v1/dealer-auth/logout', {
            method: 'POST'
        });
        router.push('/login');
    }
...
//# sourceMappingURL=src_04n27ay._.js.map